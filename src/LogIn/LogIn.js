    ...
    <div className="flex justify-center align-center">
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="text-center font-bold  text-4xl">Log In</h2>
        </div>
        <form onSubmit={handleSubmit(handlelogin)}>
          <div className="form-control w-80 mx-auto max-w-xs">
          ...
          <div className="form-control w-80 max-w-xs mx-auto">
            <label className="label">
            ...
            <input
              ...
              {...register("password", {
                required: {
                  value: true,
                  message: "please Input a Valid Paassward",
                },
                minLength: {
                  value: 4,
        ...
        <button
          class="btn btn-xs sm:btn-sm md:btn-md w-80 mx-auto my-6"
